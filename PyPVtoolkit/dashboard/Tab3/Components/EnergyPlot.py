...
class Create():
    def __init__(self , W, H):
        Curtailment = 1
        self.source = ColumnDataSource(dict(x=['Smart', 'Unity'], y=[0,0], c =['red', 'blue']))
        ...
        self.Plot.yaxis.axis_label = 'Total Energy from PV [kWh]'
    ...
    def updatePlot(self, Data):
        DataX = dict(x=['Smart', 'Unity'], y=Data, c=['red', 'blue'])
